$(function(){
	...
	//作品提交
	 $("#works_submit").click(function(){
		 ...
		 var img=$("#img").val();
		 var content_editor = "";
		 if(typeof editor!="undefined"&&type=="text"){
			 content =editor.text();	
		 ...
		 */
		 ...
		 $.ajax({    
				...
				dataType:"json",
				async : false,
				data:{"works":works,"user_id":user_id,"works_id":works_id,"description":description,"name":name,"activity_id":activity_id,"works_type":works_type,"img":img,"content":content_editor,"created_at":created_at},
